...
const steps = [
  {
    ...
    icon: <FaMapMarkerAlt />,
    description: "Pick your dream location and start planning!",
    color: "bg-blue-500",
  },
  {
    id: 2,
    ...
    icon: <FaPlane />,
    description: "Find the best deals and book your stay.",
    color: "bg-green-500",
  },
  {
    id: 3,
    ...
    description: "Make an itinerary for must-visit places.",
    color: "bg-purple-500",
  },
  {
    id: 4,
    title: "Pack Smart",
    icon: <FaSuitcase />,
    description: "Pack essentials to travel hassle-free.",
    color: "bg-yellow-500",
  },
  {
    id: 5,
    title: "Enjoy & Share Memories",
    icon: <FaCamera />,
    description: "Capture and share your best moments.",
    color: "bg-red-500",
  },
];
...
export const Hero = () => {
  ...
  const handleStartPlanning = () => {
    ...
    navigate("/create-trip", {
      state: { destination, tripDate: formattedDate },
    });
  };
    ...
    <>
      ...
      >
        ...
        <div className="bg-white/40 backdrop-blur-xl p-10 rounded-3xl shadow-2xl flex flex-col items-center space-y-8 w-full md:w-3/4 lg:w-2/3">
          ...
          <p className="text-gray-800 text-lg text-center font-medium max-w-2xl">
            ✨ Say goodbye to travel stress! Get personalized itineraries,
            top-rated attractions, and smart travel recommendations—all in one
            place. 🚀
          </p>
      ...
      <div className="my-20 px-10 relative">
        <h2 className="text-5xl font-extrabold text-center mb-8 text-[#0A2540] animate-fadeIn">
          ✨ Explore{" "}
          <span className="text-[#FF6B6B]">Trending Destinations</span> ✨
        </h2>

        <p className="text-center text-gray-600 text-lg mb-12 max-w-3xl mx-auto">
          Discover the most loved travel spots around the world, handpicked for
      ...
      <div className="relative my-20 px-10 py-16 bg-gradient-to-r from-[#1A1A2E] to-[#16213E] shadow-xl rounded-3xl">
        ...
        <p className="text-center text-gray-300 text-lg mb-12 max-w-3xl mx-auto">
          We redefine travel with seamless planning, smart transport, and
          top-notch attractions for your perfect trip.
        </p>
          ...
          {[
            {
              ...
              desc: "Plan your trip in minutes with our seamless platform.",
            },
            {
              icon: "🚍",
              title: "Smart Transport Recommendations",
              desc: "Get transport options that fit your budget and group size, powered by smart decision-making logic.",
            },
            {
              icon: "📍",
              title: "Local Hotels & Attractions",
              desc: "Explore top-rated hotels and nearby places based on your destination in real time.",
            },
            {
              icon: "🌍",
              title: "Global Destinations",
              desc: "Explore breathtaking locations worldwide with ease.",
            },
          ].map((item, index) => (
            <div
              key={index}
          ...
          {[
            {
              name: "Aarav Sharma",
              review:
                "An amazing experience! The planning was seamless and stress-free. ✨",
            },
            {
              name: "Sanya Mehta",
              review:
                "Loved how easy it was to organize my itinerary. Highly recommended! 💕",
            },
            {
              name: "Rohan Verma",
              review:
                "Great service! Everything was well-organized and effortless. 🌍",
            },
          ].map((feedback, index) => (
            <div
              key={index}
            ...
            >
              ...
              <h4 className="mt-4 text-[#0A2540] font-semibold">
                {feedback.name}
              </h4>
            </div>
          ))}
      ...
      <div className="bg-gradient-to-b from-blue-100 to-white py-16 px-10 md:px-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-[#0A2540]">
          {/* Logo & About */}
          <div>
            <h2 className="text-3xl font-extrabold">Travel Planner ✈️</h2>
            <p className="text-gray-600 mt-3 text-sm">
              Your journey, our priority. Explore the world with ease and
              comfort.
            </p>
            <p className="text-gray-500 text-xs mt-2">
              Contact: akshay.patil0410@gmail.com
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            {["Home", "Destinations", "About Us", "Blog", "Contact"].map(
              (link) => (
                <a
                  key={link}
                  href="#"
                  className="block text-gray-600 hover:text-[#FF6B6B] transition"
                >
                  {link}
                </a>
              )
            ...
            <div className="flex space-x-4">
              {[
                ...
                <a
                  ...
                  className="text-gray-500 hover:text-[#FF6B6B] transition"
                >
                  <social.icon
                    className="text-2xl"
          ...
          <div className="space-y-4">
            ...
            <div className="flex">
              <input
                ...
                className="px-4 py-2 w-full border rounded-l-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <button className="bg-[#FF6B6B] px-4 py-2 rounded-r-lg text-white font-semibold hover:bg-[#E04F4F] transition">
                Join
              </button>
            </div>
          </div>
