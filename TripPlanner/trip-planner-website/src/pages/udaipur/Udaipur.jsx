    ...
    <div>
      ...
      <div className={styles.goaContainer}>
        <div className={styles.heroSection}>
          <img src={heroImage} alt="Udaipur" className={styles.heroImage} />
          <h1 className={styles.heroText}>UDAIPUR</h1>
        </div>

        <div className={styles.goaContainer}>
          <h1 className={styles.title}>Udaipur: The Venice of the East</h1>
          <p className={styles.intro}>
            Udaipur, the crown jewel of Rajasthan, is a city of romance, regal
            charm, and breathtaking landscapes. Surrounded by the Aravalli
            Hills, its pristine lakes and majestic palaces transport you to an
            era of royal splendor.
          </p>

          <section>
            <h2>Majestic Palaces</h2>
            <p>
              The City Palace, a grand spectacle on the banks of Lake Pichola,
              is a testament to Udaipur’s regal history. With its intricate
              balconies, stunning courtyards, and museum filled with royal
              artifacts, it is a must-visit. Sajjangarh, also known as the
              Monsoon Palace, sits atop a hill, offering breathtaking panoramic
              views of the city.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Udaipur comes alive during festivals like the Mewar Festival,
              where women dress in vibrant attire, and the city is adorned with
              colorful decorations. The Shilpgram Festival showcases traditional
              Rajasthani crafts, dance, and music, celebrating the region’s rich
              cultural heritage.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Food lovers will delight in Udaipur’s traditional dishes. Savor
              the iconic Dal Baati Churma, a rustic and flavorful dish. Gatte ki
        ...
        <div className={styles.dishesSection}>
          <h2 className={styles.dishesTitle}>Top Dishes in Udaipur</h2>
